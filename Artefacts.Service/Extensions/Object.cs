...
namespace Artefacts
{
	...
	{
		///
		public class FormatStringContext
		{
		...
		{
			return FormatString(obj, new FormatStringContext(obj) { IndentLevel = indentLevel, MaxDepth = maxDepth, IndentString = indentString } );
		}
		...
		/// </remarks>
		public static string FormatString(this object obj, FormatStringContext context)
		{
			if (obj == null)
				return "(null)";
