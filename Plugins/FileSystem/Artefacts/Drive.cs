...
namespace Artefacts.FileSystem
{
	...
	public class Drive
	{
		...
		/// </summary>
		[BsonIgnore]	//DataMember(IsRequired = true)]
		public Disk Disk;	// { get; set; }

		/// <summary>
		/// Gets or sets the disk serial.
		/// </summary>
		[BsonRequired, DataMember(IsRequired = false, EmitDefaultValue = false)]
...
public string _diskSerial;
		...
		/// </summary>
		[BsonIgnoreIfDefault, DataMember(IsRequired = false, EmitDefaultValue = false)]
