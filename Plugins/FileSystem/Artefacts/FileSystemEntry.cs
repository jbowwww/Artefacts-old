...
namespace Artefacts.FileSystem
{
	...
	public class FileSystemEntry
	{
		...
		/// The drive.
		/// </summary>
		[BsonIgnore, IgnoreDataMember]//, DataMember(IsRequired = true)]
		public Drive Drive { get; set; }

		/// <summary>
		/// Gets or sets the drive parition.
		/// </summary>
		[BsonIgnore/*IfDefault*/, DataMember(IsRequired = false, EmitDefaultValue = false)]//, IgnoreDataMember]
		...
		[BsonIgnore/*IfDefault*/, DataMember(IsRequired = false, EmitDefaultValue = false)]
